/**
 * The interpreter design pattern is defines a grammatical 
 * representation for a language and provides an interpreter
 * to deal with its grammar
 */

// REF: https://medium.com/design-patterns-in-typescript/interpreter-pattern-in-typescript-edafce5eae92

// The Interpreter Pattern Concept
// https://sbcode.net/typescript/interpreter/#source-code
...
// Interpret recursively through the full AST starting from
// the root.
